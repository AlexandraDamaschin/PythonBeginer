...
# 35. Use zip to transpose data from a 4-by-3 matrix to a 3-by-4 matrix
...
# 38. Extract First Names
names = ["Rick Sanchez", "Morty Smith", "Summer Smith", "Jerry Smith", "Beth Smith"]
first_names = [name.split()[0].lower() for name in names]
print(first_names)

# 39. Multiples of Three
multiples_3 = [x * 3 for x in range(1, 21)]
print(multiples_3)

# 40. Filter Names by Scores
scores = {
    "Rick Sanchez": 70,
    "Morty Smith": 35,
    "Summer Smith": 82,
